      ...
      <main className="mx-auto flex min-h-dvh w-full max-w-5xl flex-col justify-between px-5 py-6 sm:px-8 lg:px-10">
        ...
        <section className="grid gap-10 py-16 sm:py-24 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
          <div className="max-w-2xl">
            <p className="text-sm font-medium text-accent">Customer and booking operations</p>
            ...
            <p className="mt-6 max-w-xl text-base leading-7 text-muted-foreground">
              A mobile-first workspace for small businesses to manage customers,
              bookings, confirmations, fulfilment, private feedback, and operational
              insights after an agreement is reached.
            </p>
          </div>
          ...
          >
            <h2 className="text-lg font-semibold">Current product scope</h2>
            <ul className="mt-5 space-y-4 text-sm leading-6 text-muted-foreground">
              <li>Tenant-scoped customers and bookings.</li>
              <li>Secure customer confirmation and private feedback links.</li>
              <li>Operational booking lifecycle and issue tracking.</li>
              <li>Private business insights with currency-safe value reporting.</li>
            </ul>
          </aside>
        </section>
      </main>
