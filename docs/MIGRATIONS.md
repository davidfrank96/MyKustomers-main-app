...
| `20260901230527_delivery_feedback_require_v1_association.sql`              | PREPARED, NOT APPLIED; SHA-256 `397dbaaa6fab4fb78902e13ef3273054d629df2316bfd0dd593d210d7cb9e6c4`; fail-closed post-convergence precondition plus restoration of the two strict deferred functions; historical pre-cutoff rows are not rewritten; separate approval required before application                                                          |
