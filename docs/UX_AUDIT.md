...
| UX-007 | Low | Onboarding | Onboarding completion copy implied customer and booking tools were still future-only even though they are implemented. | Source review of `/onboarding`. | Corrected the copy so business setup clearly precedes the already implemented customer and booking tools. | Fixed |
