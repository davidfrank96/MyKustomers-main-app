...
const fixtures = path.resolve(root, "../output/playwright/admin-security");
const states = [
  "attention",
  "healthy",
  "configured",
...
createServer((request, response) => {
  ...
  try {
    ...
    if (pathname === "/") {
      ...
      response.end(
        "<h1>Security &amp; Health — synthetic local review</h1><p>Actual components, mocked evidence. Application links and MFA actions require the real app; this preview is not hydrated.</p>" +
          states
...
}).listen(4175, "127.0.0.1", () => console.log("Security review: http://127.0.0.1:4175"));
